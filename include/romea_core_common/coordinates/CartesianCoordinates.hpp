#ifndef ROMEA_CORE_COMMON_COORDINATES_CARTESIANCOORDINATES_HPP_
#define ROMEA_CORE_COMMON_COORDINATES_CARTESIANCOORDINATES_HPP_
...
#endif  // ROMEA_CORE_COMMON_COORDINATES_CARTESIANCOORDINATES_HPP_
