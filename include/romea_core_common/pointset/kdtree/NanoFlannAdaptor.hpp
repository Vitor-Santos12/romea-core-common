#ifndef ROMEA_CORE_COMMON_POINTSET_KDTREE_NANOFLANNADAPTOR_HPP_
#define ROMEA_CORE_COMMON_POINTSET_KDTREE_NANOFLANNADAPTOR_HPP_
...
NanoFlannAdaptor(const PointSet<PointType> &pointSet, const int &leafMaxSize):
  ...
  index()
{
  index.reset(new Index(CARTESIAN_DIM, *this /* adaptor */,
...
#endif  // ROMEA_CORE_COMMON_POINTSET_KDTREE_NANOFLANNADAPTOR_HPP_
