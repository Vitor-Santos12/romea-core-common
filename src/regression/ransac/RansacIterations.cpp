...
//-----------------------------------------------------------------------------
RansacIterations::RansacIterations(const size_t & numberOfPoints,
...
//-----------------------------------------------------------------------------
void RansacIterations::update(const size_t & numberOfInliers,
                              const size_t & numberOfPointsToDrawModel)
{
  double outliersPercentage = double(numberOfInliers) * oneOverNumberOfPoints_;
  double outliersProbability = 1.0 - std::pow (outliersPercentage,double(numberOfPointsToDrawModel));
